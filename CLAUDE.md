...
## Gotchas
- **tree-sitter**: Uses `web-tree-sitter` (WASM) instead of native `tree-sitter` — native bindings fail on darwin/arm64 + Node 24. 14 code languages have tree-sitter extractors (TS, JS, Python, Go, Rust, Java, Kotlin, Ruby, PHP, C/C++, C#, Dart, ObjC, Swift).
