export const ru = {
  ...
  edgeLabels: {
    ...
    provides_route: { forward: "предоставляет маршрутный сервис", backward: "маршрутный сервис предоставлен" },
    consumes_route: { forward: "потребляет маршрутный сервис", backward: "маршрутный сервис потреблён" },
    provides_api: { forward: "предоставляет API", backward: "API предоставлен" },
    consumes_api: { forward: "потребляет API", backward: "API потреблён" },
    injects: { forward: "внедряет", backward: "внедрено" },
    navigates_to: { forward: "переходит к", backward: "переход из" },
  ...
  wiki: {
    ...
    ubiquitousLanguage: "Единый язык",
    termHeader: "Термин",
    definitionHeader: "Определение",
    businessRules: "Бизнес-правила",
    ruleIdHeader: "ID",
    ruleHeader: "Правило",
    enforcedByHeader: "Реализуется в",
    keyEntities: "Ключевые сущности",
    fieldsLabel: "Поля",
    lifecycleLabel: "Жизненный цикл",
    integrationPoints: "Точки интеграции",
    inbound: "Входящие",
    outbound: "Исходящие",
    errorScenarios: "Сценарии ошибок",
    exceptionHeader: "Исключение",
    triggerHeader: "Триггер",
    handlingHeader: "Обработка",
    severityHeader: "Серьёзность",
    flows: "Потоки",
    steps: "Шаги",
    crossServiceCalls: "Межсервисные вызовы",
    callerHeader: "Вызывающий",
    calleeHeader: "Вызываемый",
    typeHeader: "Тип",
    detailHeader: "Описание",
    services: "Сервисы",
    systemArchitecture: "Архитектура системы",
    eventFlows: "Потоки событий",
    sharedResources: "Общие ресурсы",
    flowSteps: "Шаги потока",
    ...
    endpointConsumers: "Consumers",
    endpointKafkaTopics: "Kafka Topics",
    httpEndpoints: "HTTP-эндпоинты",
    ...
    endpointTopic: "Topic",
    endpointRole: "Role",
    endpointHandler: "Handler Method",
    endpointIndex: "Endpoint Index",
    endpointByService: "By Service",
    endpointByProtocol: "By Protocol",
    endpointByTopic: "By Topic",
  },
  onboarding: {
