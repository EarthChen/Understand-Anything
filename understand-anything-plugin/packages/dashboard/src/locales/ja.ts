export const ja = {
  ...
  edgeLabels: {
    ...
    provides_route: { forward: "ルートサービスを提供", backward: "ルートサービスの提供元" },
    consumes_route: { forward: "ルートサービスを消費", backward: "ルートサービスの消費元" },
    provides_api: { forward: "APIを提供", backward: "APIの提供元" },
    consumes_api: { forward: "APIを消費", backward: "APIの消費元" },
    injects: { forward: "注入", backward: "注入される" },
    navigates_to: { forward: "遷移先", backward: "遷移元" },
  ...
  wiki: {
    ...
    ubiquitousLanguage: "ユビキタス言語",
    termHeader: "用語",
    definitionHeader: "定義",
    businessRules: "ビジネスルール",
    ruleIdHeader: "ID",
    ruleHeader: "ルール",
    enforcedByHeader: "実施箇所",
