export const zhTW = {
  ...
  edgeLabels: {
    ...
    provides_route: { forward: "提供路由服務", backward: "路由服務由其提供" },
    consumes_route: { forward: "消費路由服務", backward: "路由服務由其消費" },
    provides_api: { forward: "提供 API", backward: "API 由其提供" },
    consumes_api: { forward: "消費 API", backward: "API 由其消費" },
    injects: { forward: "注入", backward: "被注入" },
    navigates_to: { forward: "導航至", backward: "導航來源" },
  ...
  wiki: {
    ...
    modules: "模組",
    entryPoints: "入口點",
    ubiquitousLanguage: "統一語言",
    termHeader: "術語",
    definitionHeader: "定義",
    businessRules: "業務規則",
    ruleIdHeader: "編號",
    ruleHeader: "規則",
    enforcedByHeader: "執行方",
    keyEntities: "核心實體",
    fieldsLabel: "欄位",
    lifecycleLabel: "生命週期",
    integrationPoints: "整合點",
    inbound: "入站",
    outbound: "出站",
    errorScenarios: "異常場景",
    exceptionHeader: "例外類別",
    triggerHeader: "觸發條件",
    handlingHeader: "處理策略",
    severityHeader: "嚴重級別",
    flows: "業務流程",
    steps: "步驟",
    crossServiceCalls: "跨服務呼叫",
    callerHeader: "呼叫方",
    calleeHeader: "被呼叫方",
    typeHeader: "類型",
    detailHeader: "說明",
