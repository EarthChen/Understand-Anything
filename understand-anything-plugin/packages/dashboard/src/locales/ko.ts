...
edgeLabels: {
    ...
    provides_route: { forward: "라우트 서비스 제공", backward: "라우트 서비스 제공자" },
    consumes_route: { forward: "라우트 서비스 소비", backward: "라우트 서비스 소비자" },
    provides_api: { forward: "API 제공", backward: "API 제공자" },
    consumes_api: { forward: "API 소비", backward: "API 소비자" },
    injects: { forward: "주입", backward: "주입됨" },
    navigates_to: { forward: "이동 대상", backward: "이동 출처" },
  ...
  wiki: {
    ...
    modules: "모듈",
    entryPoints: "진입점",
    ubiquitousLanguage: "유비쿼터스 언어",
    termHeader: "용어",
    definitionHeader: "정의",
    businessRules: "비즈니스 규칙",
    ruleIdHeader: "ID",
    ruleHeader: "규칙",
    enforcedByHeader: "시행처",
    keyEntities: "핵심 엔티티",
    fieldsLabel: "필드",
    lifecycleLabel: "생명주기",
