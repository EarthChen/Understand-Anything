export const en = {
  ...
  edgeLabels: {
    ...
    provides_route: { forward: "provides route service", backward: "route service provided by" },
    consumes_route: { forward: "consumes route service", backward: "route service consumed by" },
    provides_api: { forward: "provides API", backward: "API provided by" },
    consumes_api: { forward: "consumes API", backward: "API consumed by" },
    injects: { forward: "injects", backward: "injected by" },
    navigates_to: { forward: "navigates to", backward: "navigated from" },
