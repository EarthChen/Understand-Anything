...
export { PropertiesConfigParser } from "./properties-parser.js";
...
import { PropertiesConfigParser } from "./properties-parser.js";
...
export function registerAllParsers(registry: PluginRegistry): void {
  ...
  registry.register(new PropertiesConfigParser());
}
